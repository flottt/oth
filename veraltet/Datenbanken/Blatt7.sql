/* Aufgabe 7.1.a: Studenten mit Ethikpr�fung */
...
/* Aufgabe 7.5.a: Studienpruefungsordnungen */
...
GROUP BY stud.SPO
 /* Aufgabe 7.5.c: Statistik */ 
SELECT v.VorlNr, v.titel 
FROM Vorlesungen v, hoeren h, Studentenneu s 
WHERE v.VorlNr = h.VorlNr 
AND h.MatrNr = s.MatrNr 
AND s.SPO = 'neueSPO'
GROUP BY v.VorlNr, v.Titel
HAVING count(*) * 2 >= (SELECT count(*) FROM Studentenneu WHERE SPO = 'neueSPO');